...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'enrollments' => App\GraphQL\Queries\EnrollmentsQuery::class,
                // 'enrollment' => App\GraphQL\Queries\EnrollmentQuery::class,
                'enrollmentsByCourse' => App\GraphQL\Queries\EnrollmentsByCourseQuery::class,
            ],
            'mutation' => [
                'createEnrollment' => App\GraphQL\Mutations\CreateEnrollmentMutation::class,
                'updateEnrollment' => App\GraphQL\Mutations\UpdateEnrollmentMutation::class,
                'deleteEnrollment' => App\GraphQL\Mutations\DeleteEnrollmentMutation::class,
            ],
            'types' => [
                'Enrollment' => App\GraphQL\Types\EnrollmentType::class,
            ],
            'middleware' => ['auth:api'], // Menggunakan middleware autentikasi seperti di controller (bearerAuth)
            'method' => ['get', 'post'],
        ],
    ],
