...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\TeacherQuery::class,
            ],
            'mutation' => [
                \App\GraphQL\Mutations\CreateTeacherMutation::class,
                \App\GraphQL\Mutations\UpdateTeacherMutation::class,
                \App\GraphQL\Mutations\DeleteTeacherMutation::class,
            ],
            'types' => [
                \App\GraphQL\Types\TeacherType::class,
            ],
            'middleware' => null,
            'method' => ['GET', 'POST'],
    ...
    //
    'types' => [
        \App\GraphQL\Types\TeacherType::class, // Keep this for global availability
    ],
